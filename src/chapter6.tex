...
\subsubsection{(c)}
Are \(R_0, R_1, R_2, \ldots\) mutually disjoint? Explain.
...
\subsubsection{(f)}
\(\dps \bigcup_{i=0}^{\infty}R_i = ?\)
\begin{proof}

\end{proof}

\subsubsection{(g)}
\(\dps \bigcap_{i=0}^{\infty}R_i = ?\)
