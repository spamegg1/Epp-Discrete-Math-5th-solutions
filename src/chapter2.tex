...
\usepackage{amsmath,mathtools,amsfonts,amsthm,amssymb,hyperref,cancel,tcolorbox}\usepackage{wasysym,geometry,latexsym,parskip,bookmark,mathtools,float,xcolor}
